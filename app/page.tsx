...
export default function DealerMath() {
  ...
  return (
    <div className="flex min-h-svh flex-col bg-slate-100">
      {/* Header */}
      <div className="flex w-full items-center justify-between gap-2 bg-blue-950 py-5 px-4">
        ...
        <Link href="#" className="text-white hover:text-gray-300 font-semibold border-2 py-2 px-4 rounded-lg">
          Login
        </Link>
      </div>
